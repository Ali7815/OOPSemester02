...
namespace Ocean_Navigation.UI
{
    class OceanUI
    {
        ...
        static public void disply_ship()
        {
            ...
            {
                if (s == OceanCRUD.Ships[i].name)
                {
                    flag = true;
                    Console.WriteLine("Ship is at " + OceanCRUD.Ships[i].longitude.degree + "\u00b0" + OceanCRUD.Ships[i].longitude.minutes + "\u00b0" + OceanCRUD.Ships[i].longitude.direction + " and " + OceanCRUD.Ships[i].latitude.degree + "\u00b0" + OceanCRUD.Ships[i].latitude.minutes + "\u00b0" + OceanCRUD.Ships[i].latitude.direction);
                }
            }
            if (flag == false)
            {
